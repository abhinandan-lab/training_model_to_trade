...
if show_plot:
    ...
    # FIXED: Raw fractal markers with np.nan instead of None
    ...
    # FIXED: BOS/CHoCH markers with np.nan instead of None
    prices = []
    colors = []
    for e in events:
        idx = e["bar_idx"]
    ...
    # Build plot kwargs with warning suppression
    plot_kwargs = {
        "type": "candle",
        "style": style,
        "addplot": apds,
        ...
        "ylabel": "Price",
        "volume": False,
        "warn_too_much_data": num_bars + 100,  # FIXED: Suppress warning for large datasets
        **hline_kwargs,
    }
